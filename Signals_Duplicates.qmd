...
```{r summary-table}
if (nrow(dupes) > 0) {
    ever::authenticate_drive_sheets() 
    sheet_id <- gs4_create("Dupes_Data", sheets = "Sheet1")
    write_sheet(dupes, ss = sheet_id, sheet = "Sheet1")
    # message("Sheet URL: https://docs.google.com/spreadsheets/d/", sheet_id)
    drive_share(sheet_id, role = "writer", type = "domain", domain = "evebio.org")
...
Sheet URL:
[`r paste0("https://docs.google.com/spreadsheets/d/", sheet_id)`](`r paste0("https://docs.google.com/spreadsheets/d/", sheet_id)`)
